<template>
  <z-container>
    <z-breadcrumbs :items="[{ name: 'Home', link: { name: 'home' }}, { name: 'Elements' }, { name: 'Tables', link: { name: 'docsTable' }}]" />
    <h4>Tables</h4>
    ...
    <p>
      ...
      <code>&lt;z-tr/&gt;</code>, <code>&lt;z-th/&gt;</code>, <code>&lt;z-td/&gt;</code>, <code>&lt;z-tfoot/&gt;</code>
    </p>
    ...
    <z-table stripped hover shrink>
      ...
      <z-tfoot>
        <z-tr>
          <z-td colspan='3'>
            <strong>Some footer description.</strong>
          </z-td>
        </z-tr>
      </z-tfoot>
    </z-table>
    ...
    <z-table scrollable shrink>
      ...
      <z-tbody>
        <z-tr>
          <z-td><code>stripped</code></z-td>
          <z-td>applies zebra striped style</z-td>
          <z-td>Boolean</z-td>
          <z-td>--</z-td>
    ...
    <z-table scrollable shrink>
      ...
      <z-tbody>
        <z-tr>
          ...
          <z-td>applies active row style</z-td>
          <z-td>Boolean</z-td>
          <z-td>--</z-td>
          <z-td><code>false</code></z-td>
        </z-tr>
